...
public class Key {
    ...
    public Key(int id, String api_key, String type, Date expired, Date registered, int limits_by_hour, int limits_by_minute, int limits_by_month, int limits_total) {
        this.id = id;
